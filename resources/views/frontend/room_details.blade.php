                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-6 col-lg-3 col-md-6">
                          <div class="singles_item">
                            ...
                            <div class="info">
                              <h4 class="name">Ameneties</h4>
                              <p class="value text-center">{{count($amenities)}}</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-xs-6 col-lg-3 col-md-6">
                          <div class="singles_item">
                            ...
                            <div class="info">
                              ...
                              <p class="value text-center">{{@$room_details->room_type->title}}</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-xs-6 col-lg-3 col-md-6">
                          <div class="singles_item">
                            ...
                            <div class="info">
                              <h4 class="name">Room Capacity</h4>
                              <p class="value text-center">
                                Adults: {{@$room_details->room_type->adult_capacity}} | Kids: {{@$room_details->room_type->kids_capacity}}
                              </p>
                            </div>
                          </div>
                        </div>
