...
return [ 
    ...
    'FLASH_CONTACT_US_1'=>'Thank you! Your message has been successfully sent. We will contact you very soon!',
    'FLASH_CONTACT_US_0'=>'Message sent failed.Please try again after some time.',
    'FLASH_RESERVATION_CANCELLED_1'=> 'Reservation cancelled successfully',
    'FLASH_RESERVATION_CANCELLED_0'=> 'Reservation cancelled failed',

    'SUPER_ADMIN_ID'=>1, //from user table for notification
    'OTP_LIMIT'=>'30',
    'CACHING_TIME'=>30, //minutes
    ...
    'PAYMENT_PURPOSE'=>[
      ...
      'ROOM_ADVANCE_REV'=>'Room Advance Amount Reversed', 
      'ROOM_AMOUNT_REV'=>'Room Amount Reversed',
      'FOOD_ADVANCE_REV'=>'Food Advance Amount Reversed', 
      'FOOD_AMOUNT_REV'=>'Food Amount Reversed',
      'LAUNDRY_AMOUNT_REV'=>'Laundry Amount Reversed',
      'EXPENSE'=>'Expense',
      'OTHER'=>'Other'
    ],
    'DISCOUNT_TYPES'=>[
